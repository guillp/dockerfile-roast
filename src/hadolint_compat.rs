...
fn mapping_status(dl: &str) -> Option<bool> {
    ...
    Some(match dl {
        ...
        | "DL3057" | "DL3059" | "DL3060" | "DL3061" | "DL3062" | "DL3063" | "DL3065" | "DL4000"
        | "DL4001" | "DL4003" | "DL4004" | "DL4006" => true,
...
fn all_mapped_df() -> BTreeSet<&'static str> {
    [
        ...
        "DL3057", "DL3059", "DL3060", "DL3061", "DL3062", "DL3063", "DL3064", "DL3065", "DL4000",
        "DL4001", "DL4003", "DL4004", "DL4006",
    ]
    .into_iter()
