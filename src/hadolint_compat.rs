...
fn mapping_status(dl: &str) -> Option<bool> {
    ...
    Some(match dl {
        ...
        | "DL3040" | "DL3042" | "DL3043" | "DL3044" | "DL3045" | "DL3046" | "DL3047" | "DL3059"
        | "DL3060" | "DL3061" | "DL3062" | "DL4000" | "DL4001" | "DL4003" | "DL4004" | "DL4006" => {
            true
        }
...
fn all_mapped_df() -> BTreeSet<&'static str> {
    [
        ...
        "DL3040", "DL3041", "DL3042", "DL3043", "DL3044", "DL3045", "DL3046", "DL3047", "DL3059",
        "DL3060", "DL3061", "DL3062", "DL4000", "DL4001", "DL4003", "DL4004", "DL4006",
    ]
    .into_iter()
